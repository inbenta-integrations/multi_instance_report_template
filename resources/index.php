                ...
                <table class="table table-sm table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th id="col_no_click_sessions" class="sessionCol">No Clicks Sessions</th>
                            ...
                            <th id="col_found_uqs" class="userQstnCol">Found % User Questions</th>
                            <th id="col_no_clicks_uqs" class="userQstnCol">No Clicks % User Questions</th>
                            <th id="col_not_found_uqs" class="userQstnCol">Not Found % User Questions</th>
                        </tr>
                    </thead>
                    <tbody id="data_table">
                    </tbody>
